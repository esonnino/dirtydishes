      ...
      <div className="flex items-center h-full px-3 py-2">
        ...
        <div className="flex items-center space-x-6 w-[240px]">
          <div className="flex items-center">
            <button className="p-1.5 text-[#42526E] hover:bg-[#EBECF0] rounded ml-[3px]">
            ...
            <Link href="/" className="flex items-center space-x-[5px] ml-[7px]">
          ...
          <div className="w-[540px]">
            <div className="relative">
              <input
                type="text"
                placeholder="Search"
                className="w-full h-[32px] pl-8 pr-8 text-[14px] font-['Inter var'] bg-white border border-[#0B1228]/[0.14] rounded-[6px] placeholder-[#7A869A] hover:bg-[#FAFBFC] hover:border-[#0B1228]/[0.14] focus:bg-white focus:border-[#4C9AFF] focus:ring-2 focus:ring-[#4C9AFF]/30 focus:outline-none transition-colors"
              />
              <svg className="absolute left-2 top-[9px] w-[14px] h-[14px]" width="14" height="14" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
